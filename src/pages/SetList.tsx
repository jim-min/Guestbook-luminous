  ...
  const phase1: Track[] = [
    {
      ...
      credits: "V. 윤채원  G. 김지민 홍지유  B. 전성령  D. 박수진",
    ...
    },
    {
      ...
      credits: "V. 이희빈  K. 최동건  G. 김지민 류수연  B. 강은미  D. 신예진",
    ...
    },
    {
      id: 4,
      title: "날아 - 이희빈",
      credits: "V. 이희빈  K. 최동건  G. 강현국 양인영  B. 강은미  D. 전성령  Chorus. 윤채원",
    ...
    },
    {
      ...
      credits: "V. 김지우  G. 양인영  B. 류수연  B2. 조민서  D. 송현아",
      cover: "https://image.bugsm.co.kr/album/images/500/372969/37296988.jpg",
    },
    {
      id: 8,
      title: "오리날다 - 체리필터",
      credits: "V. 이희빈  K. 이관준  G. 김지민 심현진  B. 전성령  D. 강호준  Chorus. 강민소",
  ...
  const phase2: Track[] = [
    {
      id: 9,
      title: "UGLY - 2NE1",
      credits: "V. 윤채원  K. 이관준  G. 김지민 심현진  B. 강은미  D. 박수진",
                  ...
                  <LiquidGlassList>
                    <div className="flex items-center justify-between w-full gap-4">
                      ...
                      <div className="">
                        ...
                        <div className="text-xs text-gray-900 mt-1 text-end mr-2">{track.credits}</div>
                      </div>
                    </div>
                  </LiquidGlassList>
                </div>
